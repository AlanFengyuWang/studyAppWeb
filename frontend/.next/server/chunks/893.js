...
const Logo = (props)=>/*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx(_chakra_ui_react__WEBPACK_IMPORTED_MODULE_1__.chakra.svg, {
        color: "accent",
        height: "12",
        width: "auto",
        viewBox: "0 0 89 89",
...
__webpack_require__.d(__webpack_exports__, {
  "Z": () => (/* binding */ login_OAuthButtonGroup)
});
...
;// CONCATENATED MODULE: ./src/components/login/ProviderIcons.tsx


const GoogleIcon = (0,react_.createIcon)({
...
const FaceBookIcon = (0,react_.createIcon)({
...
const GitHubIcon = (0,react_.createIcon)({
...
const TwitterIcon = (0,react_.createIcon)({
...
;// CONCATENATED MODULE: ./src/components/login/OAuthButtonGroup.tsx
...
const providers = [
    {
        name: "Google",
        signInName: "google",
        icon: /*#__PURE__*/ jsx_runtime_.jsx(GoogleIcon, {
            boxSize: "5"
        })
    },
    {
        name: "Twitter",
        signInName: "google",
        icon: /*#__PURE__*/ jsx_runtime_.jsx(TwitterIcon, {
            boxSize: "5"
        })
    },
    {
        name: "GitHub",
        signInName: "google",
        icon: /*#__PURE__*/ jsx_runtime_.jsx(GitHubIcon, {
            boxSize: "5"
        })
    }, 
];
const OAuthButtonGroup = (isSigningUp)=>{
    return /*#__PURE__*/ jsx_runtime_.jsx(react_.ButtonGroup, {
        variant: "outline",
        spacing: "4",
        width: "full",
        children: providers.map(({ name , signInName , icon  })=>/*#__PURE__*/ (0,jsx_runtime_.jsxs)(react_.Button, {
                width: "full",
                onClick: ()=>(0,external_next_auth_react_.signIn)(signInName)
                ,
                children: [
...
/* harmony default export */ const login_OAuthButtonGroup = (OAuthButtonGroup);
